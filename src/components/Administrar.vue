              ...
              <v-list-item-content>
                ...
                <v-dialog v-model="banda.dialog" width="80%">
                  <v-card>
                    ...
                    <v-form @submit.prevent="modifyBand(i)" ref="form" v-model="banda.valid" lazy-validation>
                      <v-text-field v-model="banda.title" label="Nombre de la banda" type="name" required>
                        {{banda.title}}</v-text-field>
                      <v-text-field v-model="banda.imgSrc" label="URL de imagen de la banda" type="url"
                        :placeholder="banda.imgSrc" required></v-text-field>
                      <v-text-field v-model="banda.bannerSrc" label="URL del banner de la banda" type="url"
                        :placeholder="banda.bannerSrc" required></v-text-field>
                      <v-text-field v-model="banda.text" label="Descripción de la banda" type="text"
                        :placeholder="banda.text" required></v-text-field>
                      <v-text-field v-model="banda.description" label="Bio de la banda" type="text"
                        :placeholder="banda.description" required></v-text-field>
                      ...
                      <v-checkbox v-model="banda.checkbox"
                        :rules="[v => !!v || '¡Necesita validar sus modificaciones!']" label="Marque para validar"
                        required></v-checkbox>

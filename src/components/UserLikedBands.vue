<template>
    <div>
        <v-card v-if="currentUserData.likes.length > 0" class="d-flex flex-column py-10 bands-card"  style="min-height: 80vh">
            ...
            <v-row class="mx-3 d-flex justify-center ">
                    <v-card class="col-sm col-md-4 col-lg-3 mx-3 band-card d-flex justify-center align-center" v-for="(likedBand, i) in currentUserData.likes" :key="i"
                        outlined style="min-height: 30vh">
